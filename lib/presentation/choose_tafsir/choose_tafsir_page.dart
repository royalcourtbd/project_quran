...
import 'package:project_quran/presentation/choose_tafsir/widgets/availavle_tafsir_card.dart';
import 'package:project_quran/presentation/choose_tafsir/widgets/downloaded_tafsir_card.dart';
...
class ChooseTafsirPage extends StatelessWidget {
  const ChooseTafsirPage({super.key});
                ...
                children: [
                  SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                        TafsirSearchField(
                          hintText: 'Search Tafsir',
                        ),
                        SizedBox(height: 10.px),
                        const DownloadedTafsirCard(),
                        SizedBox(height: 10.px),
...
class TafsirSearchField extends StatelessWidget {
  String hintText;
  TafsirSearchField({
    super.key,
